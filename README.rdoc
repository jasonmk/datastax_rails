...
Fulltext searching does not work.  Apparently, when inserting documents via CQL, they don't run through SOLR's
copyField directives which are required for fulltext searching.  I'm waiting to hear back on Datastax about
whether this is intended functionality or not.